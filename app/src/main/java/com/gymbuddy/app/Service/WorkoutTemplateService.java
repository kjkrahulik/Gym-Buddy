...
public class WorkoutTemplateService {
    ...
    public ArrayList<WorkoutTemplate> generateSplit(Goal goal) {
        ...
        boolean extended   = goal.isTimeCommitment();
        boolean cardio     = (type == Goal.GoalType.CUTTING || type == Goal.GoalType.WEIGHT_LOSS);
        ...
        switch (days) {
            ...
            case 1: // FULL BODY
                switch (type) {
                    case BULKING: {
                        WorkoutTemplate t = newTemplate("Full Body – Bulking", "Heavy compound full body for muscle growth");
                        ...
                        if (extended) {
                            addExercise(t, "Incline Dumbbell Press", "Chest", 6);
                            addExercise(t, "Lat Pulldown",           "Back",  7);
                        }
                        templates.add(t); break;
                    }
                    case CUTTING: {
                        WorkoutTemplate t = newTemplate("Full Body – Cutting", "Full body in a caloric deficit");
                        addExercise(t, "Goblet Squat",        "Legs",  1);
                        addExercise(t, "Barbell Bench Press", "Chest", 2);
                        addExercise(t, "Romanian Deadlift",   "Legs",  3);
                        addExercise(t, "Dumbbell Row",        "Back",  4);
                        if (extended) {
                            addExercise(t, "Overhead Press",    "Shoulders", 5);
                            addExercise(t, "Lateral Raise",     "Shoulders", 6);
                            addExercise(t, "Incline Treadmill", "Cardio",    7);
                        } else {
                            addExercise(t, "Incline Treadmill", "Cardio", 5);
                        }
                        templates.add(t); break;
                    }
                    case WEIGHT_LOSS: {
                        ...
                        addExercise(t, "Dumbbell Bench Press","Chest", 2);
                        addExercise(t, "Dumbbell Row",        "Back",  3);
                        addExercise(t, "Lunge",               "Legs",  4);
                        if (extended) {
                            addExercise(t, "Glute Bridge",      "Legs",   5);
                            addExercise(t, "Plank",             "Core",   6);
                            addExercise(t, "Incline Treadmill", "Cardio", 7);
                        } else {
                            addExercise(t, "Incline Treadmill", "Cardio", 5);
                        }
                    ...
                    case BEGINNER: default: {
                        ...
                        if (extended) {
                            addExercise(t, "Lateral Raise", "Shoulders", 6);
                            addExercise(t, "Bicep Curl",    "Biceps",    7);
                        }
                        templates.add(t); break;
                    }
                }
            ...
            case 2: // UPPER / LOWER
                switch (type) {
                    case BULKING: {
                        ...
                        addExercise(upper, "Barbell Bench Press",    "Chest",     1);
                        addExercise(upper, "Incline Dumbbell Press", "Chest",     2);
                        addExercise(upper, "Barbell Row",            "Back",      3);
                        addExercise(upper, "Overhead Press",         "Shoulders", 4);
                        addExercise(upper, "Lat Pulldown",           "Back",      5);
                        if (extended) {
                            addExercise(upper, "Pull-Up",         "Back",    6);
                            addExercise(upper, "Tricep Pushdown", "Triceps", 7);
                        }
                        WorkoutTemplate lower = newTemplate("Lower – Bulking", "Heavy squat and hinge focus");
                        addExercise(lower, "Barbell Squat",    "Legs", 1);
                        addExercise(lower, "Barbell Deadlift", "Back", 2);
                        addExercise(lower, "Leg Press",        "Legs", 3);
                        addExercise(lower, "Leg Curl",         "Legs", 4);
                        addExercise(lower, "Calf Raise",       "Legs", 5);
                        if (extended) {
                            addExercise(lower, "Leg Extension",     "Legs", 6);
                            addExercise(lower, "Romanian Deadlift", "Legs", 7);
                        }
                    ...
                    case CUTTING: {
                        ...
                        addExercise(upper, "Incline Dumbbell Press","Chest",     2);
                        addExercise(upper, "Cable Row",             "Back",      3);
                        addExercise(upper, "Overhead Press",        "Shoulders", 4);
                        if (extended) {
                            addExercise(upper, "Lat Pulldown",      "Back",    5);
                            addExercise(upper, "Tricep Extension",  "Triceps", 6);
                            addExercise(upper, "Incline Treadmill", "Cardio",  7);
                        } else {
                            addExercise(upper, "Incline Treadmill", "Cardio", 5);
                        }
                        ...
                        addExercise(lower, "Leg Curl",          "Legs", 4);
                        if (extended) {
                            addExercise(lower, "Leg Extension",    "Legs",   5);
                            addExercise(lower, "Calf Raise",       "Legs",   6);
                            addExercise(lower, "Incline Treadmill","Cardio", 7);
                        } else {
                            addExercise(lower, "Incline Treadmill", "Cardio", 5);
                        }
                        templates.add(upper); templates.add(lower); break;
                    }
                    case WEIGHT_LOSS: {
                        ...
                        if (extended) {
                            addExercise(upper, "Lateral Raise",     "Shoulders", 5);
                            addExercise(upper, "Tricep Dip",        "Triceps",   6);
                            addExercise(upper, "Incline Treadmill", "Cardio",    7);
                        } else {
                            addExercise(upper, "Incline Treadmill", "Cardio", 5);
                        }
                    ...
                    case BEGINNER: default: {
                        ...
                        if (extended) {
                            addExercise(upper, "Tricep Extension", "Triceps",   6);
                            addExercise(upper, "Lateral Raise",    "Shoulders", 7);
                        }
                        ...
                        if (extended) {
                            addExercise(lower, "Leg Extension", "Legs", 6);
                            addExercise(lower, "Glute Bridge",  "Legs", 7);
                        }
                        templates.add(upper); templates.add(lower); break;
                    }
                }
            ...
            case 3: // PUSH / PULL / LEGS
                switch (type) {
                    case BULKING: {
                        ...
                        if (extended) {
                            addExercise(push, "Tricep Pushdown", "Triceps", 6);
                            addExercise(push, "Cable Fly",       "Chest",   7);
                        }
                        WorkoutTemplate pull = newTemplate("Pull – Bulking", "Back and biceps – heavy");
                        addExercise(pull, "Barbell Deadlift", "Back",      1);
                        addExercise(pull, "Barbell Row",      "Back",      2);
                        addExercise(pull, "Pull-Up",          "Back",      3);
                        addExercise(pull, "Barbell Curl",     "Biceps",    4);
                        addExercise(pull, "Hammer Curl",      "Biceps",    5);
                        if (extended) {
                            addExercise(pull, "Lat Pulldown", "Back",      6);
                            addExercise(pull, "Face Pull",    "Shoulders", 7);
                        }
                        ...
                        if (extended) {
                            addExercise(legs, "Leg Extension", "Legs", 6);
                            addExercise(legs, "Glute Bridge",  "Legs", 7);
                        }
                    ...
                    case CUTTING: {
                        ...
                        if (extended) {
                            ...
                            addExercise(push, "Chest Fly",         "Chest",   6);
                            addExercise(push, "Incline Treadmill", "Cardio",  7);
                        } else {
                            addExercise(push, "Incline Treadmill", "Cardio", 5);
                        }
                        WorkoutTemplate pull = newTemplate("Pull – Cutting", "Back and biceps – higher reps");
                        addExercise(pull, "Barbell Deadlift", "Back",   1);
                        addExercise(pull, "Dumbbell Row",     "Back",   2);
                        addExercise(pull, "Lat Pulldown",     "Back",   3);
                        addExercise(pull, "Bicep Curl",       "Biceps", 4);
                        if (extended) {
                            addExercise(pull, "Cable Row",         "Back",      5);
                            addExercise(pull, "Face Pull",         "Shoulders", 6);
                            addExercise(pull, "Incline Treadmill", "Cardio",    7);
                        } else {
                            addExercise(pull, "Incline Treadmill", "Cardio", 5);
                        }
                        ...
                        if (extended) {
                            ...
                            addExercise(legs, "Incline Treadmill","Cardio", 7);
                        } else {
                            addExercise(legs, "Incline Treadmill", "Cardio", 5);
                        }
                        templates.add(push); templates.add(pull); templates.add(legs); break;
                    }
                    case WEIGHT_LOSS: {
                        ...
                        addExercise(push, "Overhead Press",       "Shoulders", 2);
                        addExercise(push, "Lateral Raise",        "Shoulders", 3);
                        addExercise(push, "Chest Fly",            "Chest",     4);
                        if (extended) {
                            addExercise(push, "Incline Dumbbell Press","Chest",   5);
                        ...
                        addExercise(pull, "Bicep Curl",       "Biceps",    4);
                        if (extended) {
                            addExercise(pull, "Face Pull",         "Shoulders", 5);
                    ...
                    case BEGINNER: default: {
                        ...
                        if (extended) {
                            addExercise(push, "Incline Dumbbell Press","Chest",   6);
                            addExercise(push, "Tricep Dip",            "Triceps", 7);
                        }
                        WorkoutTemplate pull = newTemplate("Pull – Beginner", "Back and biceps – light to moderate");
                        addExercise(pull, "Romanian Deadlift", "Legs",      1);
                        addExercise(pull, "Dumbbell Row",      "Back",      2);
                        addExercise(pull, "Lat Pulldown",      "Back",      3);
                        addExercise(pull, "Bicep Curl",        "Biceps",    4);
                        addExercise(pull, "Face Pull",         "Shoulders", 5);
                        if (extended) {
                            addExercise(pull, "Cable Row",   "Back",   6);
                            addExercise(pull, "Hammer Curl", "Biceps", 7);
                        }
                        ...
                        addExercise(legs, "Calf Raise",        "Legs", 5);
                        if (extended) {
                            addExercise(legs, "Leg Press",     "Legs", 6);
                            addExercise(legs, "Leg Extension", "Legs", 7);
                        }
                        templates.add(push); templates.add(pull); templates.add(legs); break;
                    }
                }
            ...
            case 4: // UPPER / LOWER x2
                switch (type) {
                    case BULKING: {
                        ...
                        if (extended) {
                            addExercise(upperA, "Cable Fly",     "Chest",   6);
                            addExercise(upperA, "Skull Crusher", "Triceps", 7);
                        }
                        ...
                        if (extended) {
                            addExercise(lowerA, "Romanian Deadlift", "Legs", 6);
                            addExercise(lowerA, "Glute Bridge",      "Legs", 7);
                        }
                        WorkoutTemplate upperB = newTemplate("Upper B – Bulking", "Heavy row focus");
                        addExercise(upperB, "Incline Barbell Press", "Chest",     1);
                        addExercise(upperB, "Barbell Row",           "Back",      2);
                        addExercise(upperB, "Pull-Up",               "Back",      3);
                        addExercise(upperB, "Lat Pulldown",          "Back",      4);
                        addExercise(upperB, "Barbell Curl",          "Biceps",    5);
                        if (extended) {
                            addExercise(upperB, "Face Pull",   "Shoulders", 6);
                            addExercise(upperB, "Hammer Curl", "Biceps",    7);
                        }
                        WorkoutTemplate lowerB = newTemplate("Lower B – Bulking", "Heavy hinge focus");
                        addExercise(lowerB, "Barbell Squat",     "Legs", 1);
                        addExercise(lowerB, "Barbell Deadlift",  "Back", 2);
                        addExercise(lowerB, "Romanian Deadlift", "Legs", 3);
                        addExercise(lowerB, "Glute Bridge",      "Legs", 4);
                        addExercise(lowerB, "Calf Raise",        "Legs", 5);
                        if (extended) {
                            addExercise(lowerB, "Leg Curl",      "Legs", 6);
                            addExercise(lowerB, "Leg Extension", "Legs", 7);
                        }
                    ...
                    case CUTTING: {
                        ...
                        if (extended) {
                            ...
                            addExercise(upperA, "Cable Fly",         "Chest",   6);
                            addExercise(upperA, "Incline Treadmill", "Cardio",  7);
                        } else {
                            addExercise(upperA, "Incline Treadmill", "Cardio", 5);
                        }
                        ...
                        addExercise(lowerA, "Leg Curl",      "Legs", 4);
                        if (extended) {
                            addExercise(lowerA, "Lunge",            "Legs",   5);
                            addExercise(lowerA, "Calf Raise",       "Legs",   6);
                            addExercise(lowerA, "Incline Treadmill","Cardio", 7);
                        } else {
                            addExercise(lowerA, "Incline Treadmill", "Cardio", 5);
                        }
                        WorkoutTemplate upperB = newTemplate("Upper B – Cutting", "Row with supersets");
                        addExercise(upperB, "Incline Dumbbell Press", "Chest",     1);
                        addExercise(upperB, "Dumbbell Row",           "Back",      2);
                        addExercise(upperB, "Lat Pulldown",           "Back",      3);
                        addExercise(upperB, "Bicep Curl",             "Biceps",    4);
                        if (extended) {
                            addExercise(upperB, "Cable Row",         "Back",      5);
                            addExercise(upperB, "Face Pull",         "Shoulders", 6);
                            addExercise(upperB, "Incline Treadmill", "Cardio",    7);
                        } else {
                            addExercise(upperB, "Incline Treadmill", "Cardio", 5);
                        }
                        WorkoutTemplate lowerB = newTemplate("Lower B – Cutting", "Hinge with supersets");
                        addExercise(lowerB, "Goblet Squat",      "Legs", 1);
                        addExercise(lowerB, "Romanian Deadlift", "Legs", 2);
                        addExercise(lowerB, "Glute Bridge",      "Legs", 3);
                        addExercise(lowerB, "Leg Curl",          "Legs", 4);
                        if (extended) {
                            addExercise(lowerB, "Lunge",            "Legs",   5);
                            addExercise(lowerB, "Calf Raise",       "Legs",   6);
                            addExercise(lowerB, "Incline Treadmill","Cardio", 7);
                        } else {
                            addExercise(lowerB, "Incline Treadmill", "Cardio", 5);
                        }
                        templates.add(upperA); templates.add(lowerA);
                        templates.add(upperB); templates.add(lowerB); break;
                    }
                    case WEIGHT_LOSS: {
                        ...
                        if (extended) {
                            ...
                            addExercise(upperA, "Push-Up",            "Chest",  6);
                            addExercise(upperA, "Incline Treadmill",  "Cardio", 7);
                        } else {
                            addExercise(upperA, "Incline Treadmill", "Cardio", 5);
                        }
                        ...
                        addExercise(lowerA, "Leg Curl",         "Legs", 4);
                        if (extended) {
                            addExercise(lowerA, "Glute Bridge",     "Legs",   5);
                            addExercise(lowerA, "Calf Raise",       "Legs",   6);
                            addExercise(lowerA, "Incline Treadmill","Cardio", 7);
                        } else {
                            addExercise(lowerA, "Incline Treadmill", "Cardio", 5);
                        ...
                        addExercise(upperB, "Dumbbell Bench Press", "Chest",     1);
                        addExercise(upperB, "Dumbbell Row",         "Back",      2);
                        addExercise(upperB, "Lat Pulldown",         "Back",      3);
                        addExercise(upperB, "Hammer Curl",          "Biceps",    4);
                        if (extended) {
                            addExercise(upperB, "Face Pull",         "Shoulders", 5);
                            addExercise(upperB, "Bicep Curl",        "Biceps",    6);
                            addExercise(upperB, "Incline Treadmill", "Cardio",    7);
                        } else {
                            addExercise(upperB, "Incline Treadmill", "Cardio", 5);
                        }
                        WorkoutTemplate lowerB = newTemplate("Lower B – Weight Loss", "Lower circuit day 2");
                        addExercise(lowerB, "Bodyweight Squat",  "Legs", 1);
                        addExercise(lowerB, "Romanian Deadlift", "Legs", 2);
                        addExercise(lowerB, "Glute Bridge",      "Legs", 3);
                        addExercise(lowerB, "Leg Curl",          "Legs", 4);
                        if (extended) {
                    ...
                    case BEGINNER: default: {
                        ...
                        addExercise(upperA, "Chest Fly",               "Chest",     5);
                        if (extended) {
                            addExercise(upperA, "Incline Push-Up", "Chest",     6);
                            addExercise(upperA, "Overhead Press",  "Shoulders", 7);
                        }
                        ...
                        addExercise(lowerA, "Calf Raise",    "Legs", 5);
                        if (extended) {
                            addExercise(lowerA, "Lunge",       "Legs", 6);
                            addExercise(lowerA, "Glute Bridge","Legs", 7);
                        }
                        ...
                        addExercise(upperB, "Face Pull",            "Shoulders", 5);
                        if (extended) {
                            addExercise(upperB, "Hammer Curl", "Biceps", 6);
                            addExercise(upperB, "Cable Row",   "Back",   7);
                        }
            ...
            case 5: // PUSH / PULL / LEGS / UPPER / LOWER
                switch (type) {
                    case BULKING: {
                        ...
                        addExercise(upper, "Barbell Row",           "Back",      2);
                        addExercise(upper, "Overhead Press",        "Shoulders", 3);
                        addExercise(upper, "Lat Pulldown",          "Back",      4);
                        addExercise(upper, "Tricep Pushdown",       "Triceps",   5);
                        if (extended) {
                            addExercise(upper, "Cable Fly",    "Chest",  6);
                            addExercise(upper, "Barbell Curl", "Biceps", 7);
                        }
                        ...
                        addExercise(lower, "Calf Raise",     "Legs", 5);
                        if (extended) {
                            addExercise(lower, "Romanian Deadlift", "Legs", 6);
                            addExercise(lower, "Glute Bridge",      "Legs", 7);
                        }
                    ...
                    case CUTTING: {
                        ...
                        addExercise(lower, "Leg Extension", "Legs", 4);
                        if (extended) {
                            addExercise(lower, "Romanian Deadlift", "Legs",   5);
                            addExercise(lower, "Calf Raise",        "Legs",   6);
                            addExercise(lower, "Incline Treadmill", "Cardio", 7);
                        } else {
                            addExercise(lower, "Incline Treadmill", "Cardio", 5);
                    ...
                    case WEIGHT_LOSS: {
                        ...
                        if (extended) {
                            addExercise(upper, "Bicep Curl",        "Biceps",    5);
                            addExercise(upper, "Face Pull",         "Shoulders", 6);
                            addExercise(upper, "Incline Treadmill", "Cardio",    7);
                        } else {
                            addExercise(upper, "Incline Treadmill", "Cardio", 5);
                        }
                    ...
                    case BEGINNER: default: {
                        ...
                        if (extended) {
                            addExercise(upper, "Bicep Curl",   "Biceps", 6);
                            addExercise(upper, "Lat Pulldown", "Back",   7);
                        }
                        ...
                        addExercise(lower, "Calf Raise",        "Legs", 5);
                        if (extended) {
                            addExercise(lower, "Lunge",        "Legs", 6);
                            addExercise(lower, "Glute Bridge", "Legs", 7);
                        }
                        templates.add(push); templates.add(pull); templates.add(legs);
                        templates.add(upper); templates.add(lower); break;
            ...
            case 6: // PUSH / PULL / LEGS x2
                switch (type) {
                    case BULKING: {
                        ...
                        if (extended) {
                            addExercise(pushA, "Tricep Pushdown", "Triceps", 6);
                            addExercise(pushA, "Cable Fly",       "Chest",   7);
                        }
                        WorkoutTemplate pullA = newTemplate("Pull A – Bulking", "Heavy pull day");
                        addExercise(pullA, "Barbell Deadlift", "Back",      1);
                        addExercise(pullA, "Barbell Row",      "Back",      2);
                        addExercise(pullA, "Pull-Up",          "Back",      3);
                        addExercise(pullA, "Barbell Curl",     "Biceps",    4);
                        addExercise(pullA, "Hammer Curl",      "Biceps",    5);
                        if (extended) {
                            addExercise(pullA, "Face Pull",    "Shoulders", 6);
                            addExercise(pullA, "Lat Pulldown", "Back",      7);
                        }
                        ...
                        if (extended) {
                            addExercise(legsA, "Leg Extension", "Legs", 6);
                            addExercise(legsA, "Glute Bridge",  "Legs", 7);
                        }
                        ...
                        if (extended) {
                            addExercise(pushB, "Chest Fly",      "Chest",     6);
                            addExercise(pushB, "Overhead Press", "Shoulders", 7);
                        }
                        WorkoutTemplate pullB = newTemplate("Pull B – Bulking", "Volume pull day");
                        addExercise(pullB, "Barbell Deadlift", "Back",      1);
                        addExercise(pullB, "Lat Pulldown",     "Back",      2);
                        addExercise(pullB, "Cable Row",        "Back",      3);
                        addExercise(pullB, "Bicep Curl",       "Biceps",    4);
                        addExercise(pullB, "Hammer Curl",      "Biceps",    5);
                        if (extended) {
                            addExercise(pullB, "Face Pull",    "Shoulders", 6);
                            addExercise(pullB, "Reverse Fly",  "Back",      7);
                        }
                        WorkoutTemplate legsB = newTemplate("Legs B – Bulking", "Volume leg day");
                        addExercise(legsB, "Barbell Squat",  "Legs", 1);
                        ...
                        if (extended) {
                            addExercise(legsB, "Front Squat",  "Legs", 6);
                            addExercise(legsB, "Glute Bridge", "Legs", 7);
                        }
                    ...
                    case CUTTING: {
                        ...
                        addExercise(pushA, "Barbell Bench Press",    "Chest",     1);
                        addExercise(pushA, "Incline Dumbbell Press", "Chest",     2);
                        addExercise(pushA, "Overhead Press",         "Shoulders", 3);
                        addExercise(pushA, "Lateral Raise",          "Shoulders", 4);
                        if (extended) {
                            addExercise(pushA, "Tricep Dip",         "Triceps", 5);
                            addExercise(pushA, "Chest Fly",          "Chest",   6);
                            addExercise(pushA, "Incline Treadmill",  "Cardio",  7);
                        } else {
                            addExercise(pushA, "Incline Treadmill", "Cardio", 5);
                        }
                        WorkoutTemplate pullA = newTemplate("Pull A – Cutting", "Heavy pull – caloric deficit");
                        addExercise(pullA, "Barbell Deadlift", "Back",      1);
                        addExercise(pullA, "Barbell Row",      "Back",      2);
                        addExercise(pullA, "Lat Pulldown",     "Back",      3);
                        addExercise(pullA, "Barbell Curl",     "Biceps",    4);
                        if (extended) {
                            addExercise(pullA, "Face Pull",         "Shoulders", 5);
                            addExercise(pullA, "Hammer Curl",       "Biceps",    6);
                            addExercise(pullA, "Incline Treadmill", "Cardio",    7);
                        } else {
                            addExercise(pullA, "Incline Treadmill", "Cardio", 5);
                        }
                        ...
                        addExercise(legsA, "Leg Curl",          "Legs", 4);
                        if (extended) {
                            addExercise(legsA, "Leg Extension",    "Legs",   5);
                            addExercise(legsA, "Calf Raise",       "Legs",   6);
                            addExercise(legsA, "Incline Treadmill","Cardio", 7);
                        } else {
                            addExercise(legsA, "Incline Treadmill", "Cardio", 5);
                        }
                        WorkoutTemplate pushB = newTemplate("Push B – Cutting", "Volume push – higher reps");
                        addExercise(pushB, "Dumbbell Bench Press",    "Chest",     1);
                        addExercise(pushB, "Incline Dumbbell Press",  "Chest",     2);
                        addExercise(pushB, "Dumbbell Shoulder Press", "Shoulders", 3);
                        addExercise(pushB, "Lateral Raise",           "Shoulders", 4);
                        if (extended) {
                            addExercise(pushB, "Tricep Extension",  "Triceps", 5);
                            addExercise(pushB, "Cable Fly",         "Chest",   6);
                            addExercise(pushB, "Incline Treadmill", "Cardio",  7);
                        } else {
                            addExercise(pushB, "Incline Treadmill", "Cardio", 5);
                        }
                        WorkoutTemplate pullB = newTemplate("Pull B – Cutting", "Volume pull – higher reps");
                        addExercise(pullB, "Barbell Deadlift", "Back",      1);
                        addExercise(pullB, "Dumbbell Row",     "Back",      2);
                        addExercise(pullB, "Cable Row",        "Back",      3);
                        addExercise(pullB, "Face Pull",        "Shoulders", 4);
                        if (extended) {
                            addExercise(pullB, "Bicep Curl",        "Biceps", 5);
                            addExercise(pullB, "Hammer Curl",       "Biceps", 6);
                            addExercise(pullB, "Incline Treadmill", "Cardio", 7);
                        } else {
                            addExercise(pullB, "Incline Treadmill", "Cardio", 5);
                        }
                        ...
                        addExercise(legsB, "Leg Curl",      "Legs", 4);
                        if (extended) {
                            addExercise(legsB, "Romanian Deadlift", "Legs",   5);
                            addExercise(legsB, "Calf Raise",        "Legs",   6);
                            addExercise(legsB, "Incline Treadmill", "Cardio", 7);
                        } else {
                            addExercise(legsB, "Incline Treadmill", "Cardio", 5);
                        }
                        templates.add(pushA); templates.add(pullA); templates.add(legsA);
                        templates.add(pushB); templates.add(pullB); templates.add(legsB); break;
                    }
                    case WEIGHT_LOSS: {
                        ...
                        addExercise(pullA, "Barbell Deadlift", "Back",      1);
                        addExercise(pullA, "Dumbbell Row",     "Back",      2);
                        addExercise(pullA, "Lat Pulldown",     "Back",      3);
                        ...
                        addExercise(pushB, "Incline Dumbbell Press",  "Chest",     1);
                        addExercise(pushB, "Dumbbell Shoulder Press", "Shoulders", 2);
                        addExercise(pushB, "Lateral Raise",           "Shoulders", 3);
                        addExercise(pushB, "Tricep Extension",        "Triceps",   4);
                        if (extended) {
                            addExercise(pushB, "Cable Fly",          "Chest",     5);
                            addExercise(pushB, "Overhead Press",     "Shoulders", 6);
                            addExercise(pushB, "Incline Treadmill",  "Cardio",    7);
                        } else {
                            addExercise(pushB, "Incline Treadmill", "Cardio", 5);
                        }
                    ...
                    case BEGINNER: default: {
                        ...
                        addExercise(pushA, "Chest Fly",               "Chest",     5);
                        if (extended) {
                            addExercise(pushA, "Incline Push-Up", "Chest",   6);
                            addExercise(pushA, "Tricep Dip",      "Triceps", 7);
                        }
                        WorkoutTemplate pullA = newTemplate("Pull A – Beginner", "Pull day 1");
                        addExercise(pullA, "Romanian Deadlift", "Legs",      1);
                        addExercise(pullA, "Dumbbell Row",      "Back",      2);
                        addExercise(pullA, "Lat Pulldown",      "Back",      3);
                        addExercise(pullA, "Bicep Curl",        "Biceps",    4);
                        addExercise(pullA, "Face Pull",         "Shoulders", 5);
                        if (extended) {
                            addExercise(pullA, "Hammer Curl", "Biceps", 6);
                            addExercise(pullA, "Cable Row",   "Back",   7);
                        }
                        ...
                        addExercise(legsA, "Calf Raise",        "Legs", 5);
                        if (extended) {
                            addExercise(legsA, "Leg Press",    "Legs", 6);
                            addExercise(legsA, "Glute Bridge", "Legs", 7);
                        }
                        ...
                        addExercise(pullB, "Romanian Deadlift", "Legs",      1);
                        addExercise(pullB, "Dumbbell Row",      "Back",      2);
                        addExercise(pullB, "Cable Row",         "Back",      3);
                        addExercise(pullB, "Face Pull",         "Shoulders", 4);
                        addExercise(pullB, "Bicep Curl",        "Biceps",    5);
                        if (extended) {
                            addExercise(pullB, "Hammer Curl",  "Biceps", 6);
                            addExercise(pullB, "Lat Pulldown", "Back",   7);
                        }
                        WorkoutTemplate legsB = newTemplate("Legs B – Beginner", "Leg day 2");
                        addExercise(legsB, "Goblet Squat",  "Legs", 1);
                        addExercise(legsB, "Lunge",         "Legs", 2);
                        addExercise(legsB, "Glute Bridge",  "Legs", 3);
                        addExercise(legsB, "Leg Curl",      "Legs", 4);
                        addExercise(legsB, "Leg Extension", "Legs", 5);
                        if (extended) {
                            addExercise(legsB, "Leg Press",    "Legs", 6);
                            addExercise(legsB, "Calf Raise",   "Legs", 7);
                        }
                        templates.add(pushA); templates.add(pullA); templates.add(legsA);
                        templates.add(pushB); templates.add(pullB); templates.add(legsB); break;
                    }
